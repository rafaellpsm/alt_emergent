...
class DeploymentReadinessChecker:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if "access_token" in data:
                    ...
                    self.log_result(f"{user_type.title()} Authentication", False, "No access token in response", critical=True)
                    return False
            else:
                self.log_result(f"{user_type.title()} Authentication", False, f"Login failed with status {response.status_code}: {response.text}", critical=True)
                return False
                
        except Exception as e:
            self.log_result(f"{user_type.title()} Authentication", False, f"Login error: {str(e)}", critical=True)
            return False
    ...
    def test_authentication_system(self):
        ...
        # Test admin login
        admin_success = self.login_as_user(ADMIN_EMAIL, ADMIN_PASSWORD, "admin")
        
        # Test member login
        member_success = self.login_as_user(MEMBER_EMAIL, MEMBER_PASSWORD, "member")
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if created_property.get("status_aprovacao") == "pendente":
                    ...
                    response = self.session.put(f"{API_BASE}/imoveis/{property_id}", json=update_data)
                    if response.status_code == 200:
                        self.log_result(
                            "Property Editing", 
                            True, 
                    ...
                    if self.login_as_user(ADMIN_EMAIL, ADMIN_PASSWORD, "admin"):
                        ...
                        if response.status_code == 200:
                            ...
                            if response.status_code == 200:
                                ...
                                property_in_list = any(p.get("id") == property_id for p in approved_properties)
            ...
            self.log_result("Property Management System", False, f"Error: {str(e)}", critical=True)
            return False
    ...
    def test_photo_upload_system(self):
        ...
        try:
            ...
            self.log_result("Photo Upload System", False, f"Error: {str(e)}", critical=True)
            return False
    ...
    def test_email_notification_system(self):
        ...
        try:
            ...
            self.log_result("Email Notification System", False, f"Error: {str(e)}", critical=True)
            return False
    ...
    def test_database_operations(self):
        ...
        try:
            ...
            self.log_result("Database Operations", False, f"Error: {str(e)}", critical=True)
            return False
    ...
    def test_api_security(self):
        ...
        try:
            ...
            self.log_result("API Security", False, f"Error: {str(e)}", critical=True)
            return False
    ...
    def test_production_environment_config(self):
        ...
        try:
            ...
            self.log_result("Production Environment", False, f"Error: {str(e)}", critical=True)
            return False
