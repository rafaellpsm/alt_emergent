...
class APITester:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if "access_token" in data:
                    ...
                    self.log_result(f"{user_type.title()} Login",
                                    False, "No access token in response")
                    return False
            else:
    ...
    def test_meus_imoveis_endpoint_as_member(self):
        ...
        try:
            ...
            self.log_result("Meus Imóveis API (Member)",
    ...
    def test_create_property_with_empty_urls(self):
        ...
        try:
                ...
                if data.get("status_aprovacao") == "pendente":
                    ...
                    for field in ["link_booking", "link_airbnb"]:
                        if data.get(field) == "":
                            ...
                            url_issues.append(
                                f"{field} is empty string instead of null")
            ...
            self.log_result("Property Creation with Empty URLs",
                            False, f"Request error: {str(e)}")
            return False
    ...
    def test_property_details_loading(self):
        ...
        try:
            ...
            self.log_result("Property Details Loading",
                            False, f"Request error: {str(e)}")
            return False
    ...
    def test_property_owner_information(self):
        ...
        try:
            ...
            response = self.session.get(
                f"{API_BASE}/imoveis/{property_id}/proprietario")
            ...
            if response.status_code == 200:
                ...
                exposed_sensitive = [
                    field for field in sensitive_fields if field in data]
            ...
            self.log_result("Property Owner Information",
                            False, f"Request error: {str(e)}")
            return False
    ...
    def test_password_change_system(self):
        ...
        try:
            ...
            response = self.session.put(
                f"{API_BASE}/auth/alterar-senha", json=password_data)
            ...
            if response.status_code == 200:
                ...
                if "sucesso" in data.get("message", "").lower():
                    ...
                    login_test = self.test_login_with_new_password(
                        "novaSenha123")
            ...
            self.log_result("Password Change System (Valid)",
                            False, f"Request error: {str(e)}")
            return False
    ...
    def test_password_change_wrong_current(self):
        ...
        try:
            ...
            self.log_result("Password Change System (Wrong Current)",
                            False, f"Request error: {str(e)}")
            return False
    ...
    def change_password_back(self):
        ...
        try:
            ...
            self.log_result("Password Reset to Original",
                            False, f"Request error: {str(e)}")
        ...
        try:
            ...
            try:
                ...
                self.log_result("Photo Upload System", False,
                                f"Photo upload test error: {str(e)}")
                return False
    ...
    def test_create_property_with_photos(self):
        ...
        try:
            ...
            if hasattr(self, 'uploaded_photo_url'):
                ...
                photo_urls = ["/uploads/placeholder1.jpg",
            ...
            if response.status_code == 200:
                ...
                if data.get("status_aprovacao") == "pendente":
                    ...
                    if len(created_photos) == len(photo_urls):
                        ...
                        photos_are_strings = all(isinstance(
                            url, str) for url in created_photos)
            ...
            self.log_result("Property Creation with Photos",
                            False, f"Request error: {str(e)}")
            return False
    ...
    def test_property_details_with_photos(self):
        ...
        try:
            ...
            if not property_id:
                ...
                if response.status_code == 200:
                    properties = response.json()
                    properties_with_photos = [p for p in properties if p.get(
                        "fotos") and len(p.get("fotos", [])) > 0]
                    ...
                    if properties_with_photos:
                        ...
                        if admin_response.status_code == 200:
                            ...
                            pending_with_photos = [p for p in pending_properties if p.get(
                                "fotos") and len(p.get("fotos", [])) > 0]
            ...
            if response.status_code == 200:
                ...
                if fotos and len(fotos) > 0:
                    ...
                    photos_valid = all(isinstance(url, str)
                                       and url for url in fotos)
            ...
            self.log_result("Property Details with Photos",
                            False, f"Request error: {str(e)}")
            return False
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                target_property = next(
                    (p for p in pending_properties if p.get("id") == property_id), None)

                if target_property:
                    fotos = target_property.get("fotos", [])

                    if fotos and len(fotos) > 0:
                        photos_valid = all(isinstance(
                            url, str) and url for url in fotos)
    ...
    def test_photo_upload_file_restrictions(self):
        ...
        try:
            ...
            self.log_result("Photo Upload File Type Restriction",
                            False, f"Request error: {str(e)}")
            return False
    ...
    def test_get_pending_properties(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_result(
                    ...
                    {"count": len(data), "properties": [
                        {"id": p.get("id"), "titulo": p.get("titulo")} for p in data[:3]]}
                )
                return True
            else:
                self.log_result(
            ...
            self.log_result("Get Pending Properties", False,
                            f"Request error: {str(e)}")
            return False
    ...
    def test_property_approval_email_system(self):
        ...
        try:
            ...
            self.log_result("Property Approval Email System",
                            False, f"Request error: {str(e)}")
            return False
    ...
    def test_email_configuration_check(self):
        ...
        try:
            ...
            self.log_result("Email Configuration Check",
                            False, f"Request error: {str(e)}")
            return False
    ...
    def test_property_approval_flow(self):
        ...
        try:
            ...
            test_property_in_pending = any(
                p.get("id") == test_property_id for p in pending_properties)
            ...
            response = self.session.post(
                f"{API_BASE}/admin/imoveis/{test_property_id}/aprovar")
            ...
            test_property_in_approved = any(
                p.get("id") == test_property_id for p in approved_properties)
            ...
            self.log_result("Property Approval Flow", False,
                            f"Request error: {str(e)}")
            return False
    ...
    def test_objectid_removal_all_endpoints(self):
        ...
        try:
            ...
            self.log_result("ObjectId Removal All Endpoints",
                            False, f"Request error: {str(e)}")
            return False
    ...
    def test_cross_role_access(self):
        ...
        try:
            ...
            self.log_result("Cross-Role Access", False,
                            f"Request error: {str(e)}")
            return False
    ...
    def test_property_listings_both_endpoints(self):
        ...
        try:
            ...
            pending_count = sum(1 for p in member_properties if p.get(
                "status_aprovacao") == "pendente")
            approved_count = sum(1 for p in member_properties if p.get(
            ...
            non_approved = [p for p in all_properties if p.get(
                "status_aprovacao") != "aprovado"]
            ...
            member_approved_ids = {p.get("id") for p in member_properties if p.get(
                "status_aprovacao") == "aprovado"}
            ...
            self.log_result("Property Listings Both Endpoints",
                            False, f"Request error: {str(e)}")
            return False
    ...
    def test_password_recovery_system(self):
        ...
        try:
            ...
            response = self.session.post(
                f"{API_BASE}/auth/recuperar-senha", json=recovery_data)
            ...
            if response.status_code == 200:
                ...
                if expected_message in data.get("message", ""):
                    ...
                    response2 = self.session.post(
                        f"{API_BASE}/auth/recuperar-senha", json=invalid_recovery_data)
            ...
            self.log_result("Password Recovery System",
                            False, f"Request error: {str(e)}")
            return False
    ...
    def test_password_recovery_missing_email(self):
        ...
        try:
            ...
            self.log_result("Password Recovery - Missing Email",
                            False, f"Request error: {str(e)}")
            return False
        ...
        try:
            ...
            if admin_user:
                response = self.session.delete(
                    f"{API_BASE}/admin/users/{admin_user.get('id')}")
                    ...
                    if deleted_user.get("id") == test_user_id and deleted_user.get("role") == test_user_role:
                        ...
                        if response2.status_code == 200:
                            ...
                            user_still_exists = any(
                                u.get("id") == test_user_id for u in updated_users)
            ...
            self.log_result("User Deletion Admin Authorization",
                            False, f"Request error: {str(e)}")
            return False
    ...
    def test_user_deletion_non_admin_access(self):
        ...
        try:
            ...
            self.log_result("User Deletion Non-Admin Access",
                            False, f"Request error: {str(e)}")
            return False
    ...
    def test_user_deletion_invalid_user_id(self):
        ...
        try:
            ...
            response = self.session.delete(
                f"{API_BASE}/admin/users/{invalid_user_id}")
            ...
            self.log_result("User Deletion Invalid User ID",
                            False, f"Request error: {str(e)}")
            return False
    ...
    def test_email_system_integration(self):
        ...
        try:
            ...
            self.log_result("Email System Integration",
                            False, f"Request error: {str(e)}")
            return False
    ...
    def test_password_recovery_temporary_password_generation(self):
        ...
        try:
            ...
            self.log_result("Password Recovery Temporary Password Generation",
                            False, f"Request error: {str(e)}")
            return False
    ...
    def run_all_tests(self):
        ...
        print(
            "   Testing DELETE /api/admin/users/{id} endpoint with proper restrictions")
        if self.test_login(ADMIN_EMAIL, ADMIN_PASSWORD, "admin"):
        ...
        approval_tests = [
            r for r in self.test_results if "Property Approval Flow" in r["test"]]
        listing_tests = [
            r for r in self.test_results if "Property Listings" in r["test"]]
        objectid_tests = [
            r for r in self.test_results if "ObjectId Removal" in r["test"]]
        admin_tests = [
            r for r in self.test_results if "Cross-Role Access" in r["test"]]
