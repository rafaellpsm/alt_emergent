...
class PhotoSystemTester:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if "access_token" in data:
                    ...
                    self.log_result("Member Login", False,
                                    "No access token in response")
                    return False
            else:
                self.log_result(
                    "Member Login", False, f"Login failed with status {response.status_code}: {response.text}")
                return False
    ...
    def test_photo_upload_system(self):
        ...
        try:
            ...
            with tempfile.NamedTemporaryFile(suffix='.jpg', delete=False) as tmp_file:
                tmp_file.write(
                    b"fake image content for testing photo upload system")
                tmp_file.flush()
    ...
    def test_property_creation_500_error_fix(self):
        ...
        try:
            ...
            self.log_result("Property Creation 500 Error Fix",
                            False, f"Request error: {str(e)}")
            return False
